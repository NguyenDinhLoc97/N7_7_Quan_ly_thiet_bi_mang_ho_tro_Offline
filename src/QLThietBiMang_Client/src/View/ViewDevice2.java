 ...
 * @author Bv ptop 268
 */
public class ViewDevice2 extends javax.swing.JFrame {

    /**
     * Creates new form ViewDevice2
     */
    public ViewDevice2() {
    ...
    private void initComponents() {
        ...
        table2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tên sản phẩm", "Giá", "Sô lượng", "Năm sản xuất", "Năm hết  hạn", "Hãng sản xuất"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewDevice2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewDevice2().setVisible(true);
            }
        });
    }
